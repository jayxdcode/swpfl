// ==UserScript==
// @name         SWPFL userJS — Spotify variant
// @namespace    http://tampermonkey.net/
// @version      2.5.6-CSP
// @description  Spotify Web Player variant of Simple Web Panel for Lyrics (SWPFL). Synced lyrics with translation/romanization resizable/draggable panel, themed, opacity control. Translations are provided by Gemini via the Google AI Studio API (Accessed via a remote server).
// @author       jayxdcode
...
// @grant        unsafeWindow
// @connect      lrclib.net
// @connect      lyrxl.onrender.com
// @connect      genius.com
// @connect      google.com
// @connect      sv443.net
// @connect      192.168.8.10
// @connect      localhost
...
(function() {
  ...
  try {
    ...
    const BACKEND_API_KEY = null; // YOUR API KEY
